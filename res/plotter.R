...
m <- ggplot(temp, aes(x=net, y=rt, colour=factor(sfc), group=factor(sfc), fill=factor(sfc))) 
m + 
...
# Black error bars - notice the mapping of 'group=supp' -- without it, the error
# bars won't be dodged!
m <- ggplot(temp, aes(x=net, y=throughput, colour=factor(sfc), group=factor(sfc), fill=factor(sfc))) 
m + 
  geom_bar(position=position_dodge(), stat="identity") +
...
# Black error bars - notice the mapping of 'group=supp' -- without it, the error
# bars won't be dodged!
m <- ggplot(temp1, aes(x=pair, y=total_affinity, colour=factor(sfc), group=factor(sfc), fill=factor(sfc))) 
m + 
  geom_bar(position=position_dodge(), stat="identity") +
...
ids_fw$traffic <- ids_fw$traffic / max(ids_fw$traffic)
ids_fw$latency <- ids_fw$latency / max(ids_fw$latency)
meltdf1 <- melt(ids_fw, id.vars = c("time","net","sfc"), measure.vars = c("total_affinity", "vnf_a_cpu", "vnf_b_cpu", "vnf_a_mem", "vnf_b_mem", "traffic", "latency", "bnd_usage"))
...
m + 
  ...
  theme(axis.line.x = element_line(color = 'black'),
        ...
        axis.title = element_text(size = 16),
        text = element_text(size = 16)) +
  labs(title="FW x IDS", colour="Metric", group="Metric", linetype="Metric") +
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
        panel.background = element_blank(), axis.line = element_line(colour = "black")) +
  theme(legend.title = element_text(colour="black", size=10, face="bold"), legend.position="right", legend.title.align=0.5)
...
meltdf2 <- melt(fw_dpi, id.vars = c("time","net","sfc"), measure.vars = c("total_affinity", "vnf_a_cpu", "vnf_b_cpu", "vnf_a_mem", "vnf_b_mem", "traffic", "latency", "bnd_usage"))
...
m + 
  ...
  theme(axis.line.x = element_line(color = 'black'),
        ...
        axis.title = element_text(size = 16),
        text = element_text(size = 16)) +
  labs(title="FW x DPI", colour="Metric", group="Metric", linetype="Metric") +
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
        panel.background = element_blank(), axis.line = element_line(colour = "black")) +
  theme(legend.title = element_text(colour="black", size=10, face="bold"), legend.position="right", legend.title.align=0.5)
...
meltdf3 <- melt(ids_dpi, id.vars = c("time","net","sfc"), measure.vars = c("total_affinity", "vnf_a_cpu", "vnf_b_cpu", "vnf_a_mem", "vnf_b_mem", "traffic", "latency", "bnd_usage"))
...
m + 
  ...
  theme(axis.line.x = element_line(color = 'black'),
        ...
        axis.title = element_text(size = 16),
        text = element_text(size = 16)) +
  labs(title="IDS x DPI", colour="Metric", group="Metric", linetype="Metric") +
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
        panel.background = element_blank(), axis.line = element_line(colour = "black")) +
  theme(legend.title = element_text(colour="black", size=10, face="bold"), legend.position="right", legend.title.align=0.5)
